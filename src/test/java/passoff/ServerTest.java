...
public class ServerTest {
    ...
    private void checkPersonsBirth(EventsResult eventsResult, PersonsResult personsResult, Person person, String relationship, int generationsLeft) {
        ...
        Assertions.assertTrue(motherAgeAtPersonBirth <= MAX_REALISTIC_PREGNANT_AGE, relationship + "'s mother was unrealistically old at user's birth, max pregnant age: " + MAX_REALISTIC_PREGNANT_AGE);
